...
class TestOLAndOpen:
    ...
    def test_ol_sentinel(self, txt):
        ...
        assert result == {"value": 999_999.0, "unit": "ohm", "measurement_type": "CONTINUITY"}
...
class TestShortedAndHealthy:
    ...
    def test_short_phrases(self, txt):
        result = _parse_manual_reading(txt)
        assert result == {"value": 0.0, "unit": "ohm", "measurement_type": "CONTINUITY"}
    ...
    def test_d3_healthy_maps_to_500_ohm(self, txt):
        ...
        result = _parse_manual_reading(txt)
        assert result == {"value": 500.0, "unit": "ohm", "measurement_type": "CONTINUITY"}
